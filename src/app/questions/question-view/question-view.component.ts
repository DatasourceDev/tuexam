...
export class QuestionViewComponent implements OnInit {
  ...
  OnView(id) {
    this.router.navigate(["/question-view-child/", id, this.id]);
    return false;
  }
  OnApprStaffSearch() {
    this.isapproval = false;
    var formdata = { id: this.id };
    this.service.httpClientGet("api/Question/listapprstaff", formdata)
      .subscribe(result => {
        if (result == null || Object.keys(result).length == 0 || (Array.isArray(result) && result.length == 0)) {
  ...
  OnTestApprove() {
    ...
    this.service.httpClientGet("api/Question/approved", formdata)
      .subscribe(result => {
        if (result == null || Object.keys(result).length == 0 || (Array.isArray(result) && result.length == 0)) {
        }
        else {
  ...
  OnTestReject() {
    ...
    this.service.httpClientGet("api/Question/rejected", formdata)
      .subscribe(result => {
        if (result == null || Object.keys(result).length == 0 || (Array.isArray(result) && result.length == 0)) {
        }
        else {
  ...
  OnTestApproveMaster() {
    ...
    this.service.httpClientGet("api/Question/approvedmaster", formdata)
      .subscribe(result => {
        if (result == null || Object.keys(result).length == 0 || (Array.isArray(result) && result.length == 0)) {
        }
        else {
  ...
  OnTestRejectMaster() {
    ...
    this.service.httpClientGet("api/Question/rejectedmaster", formdata)
      .subscribe(result => {
        if (result == null || Object.keys(result).length == 0 || (Array.isArray(result) && result.length == 0)) {
        }
        else {
  ...
  OnTestDraftMaster() {
    ...
    this.service.httpClientGet("api/Question/draftmaster", formdata)
      .subscribe(result => {
        if (result == null || Object.keys(result).length == 0 || (Array.isArray(result) && result.length == 0)) {
        }
        else {
  ...
  OnChangeStatus() {
    ...
    this.service.httpClientGet("api/Question/changestatus", formdata)
      .subscribe(result => {
        if (result == null || Object.keys(result).length == 0 || (Array.isArray(result) && result.length == 0)) {
        }
        else {
