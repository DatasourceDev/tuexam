...
@Component({
  selector: 'app-exam-greats-per-date',
  templateUrl: './exam-greats-per-date.component.html',
  styleUrls: ['./exam-greats-per-date.component.css']
})
export class ExamGreatsPerDateComponent implements OnInit {
  ...
  OnViewBestScore(date) {
    this.service.openurl("api/PdfReport/resultform2?search_date=" + date);
    return false;
